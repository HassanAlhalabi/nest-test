...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.signIn = function (userDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isValidPassword, token, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, argon2_1.verify)(user.hash, userDto.password)];
                        case 2:
                            isValidPassword = _a.sent();
                            if (!isValidPassword) {
                                throw new common_1.ForbiddenException('Invalid Password');
                            }
                            return [4 /*yield*/, this.signToken(user.id, user.email)];
                        case 3:
                            token = _a.sent();
    ...
    (function () {
        ...
        _signIn_decorators = [(0, common_1.HttpCode)(common_1.HttpStatus.OK)];
