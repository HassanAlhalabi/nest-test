...
var PermissionGuard = function () {
    ...
    var PermissionGuard = _classThis = /** @class */ (function () {
        ...
        PermissionGuard_1.prototype.canActivate = function (context) {
            var requiredPermission = this.reflector.getAllAndOverride(permission_decorator_1.PERMISSION_KEY, [context.getHandler(), context.getClass()]);
            var user = context.switchToHttp().getRequest().user;
            return requiredPermission.every(function (permission) { var _a; return (_a = user.role.permissions) === null || _a === void 0 ? void 0 : _a.includes(permission); });
        };
