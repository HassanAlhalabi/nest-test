...
var RoleService = function () {
    ...
    var RoleService = _classThis = /** @class */ (function () {
        function RoleService_1(roleRepository) {
        ...
        RoleService_1.prototype.create = function (createRoleDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.roleRepository.save(createRoleDto)];
                        case 1:
                            newRole = _a.sent();
        ...
        RoleService_1.prototype.findAll = function (filter) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.roleRepository.findAndCount(__assign({}, (0, helpers_1.applyPagination)(filter.page, filter.pageSize, filter.ignorePagination)))];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        RoleService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var role;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.roleRepository.findOneBy({
                                id: id,
                            })];
                        case 1:
                            role = _a.sent();
        ...
        RoleService_1.prototype.update = function (id, updateRoleDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.roleRepository.update(id, updateRoleDto)];
                        case 1:
                            updatedRole = _a.sent();
