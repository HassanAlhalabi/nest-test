...
export class Migration1725185213972 implements MigrationInterface {
    name = 'Migration1725185213972'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "roles" ADD "permissions" text NOT NULL DEFAULT '[]'`);
